...
const BuySellSet = () => {
    return (
        <div className=" flex flex-row gap-[12px] justify-between  md:flex-col md:gap-[18px]">
            <Link href="/swap">
                <button className=" flex flex-row gap-[10px] p-[12px] px-8 sm:px-5 md:px-4 rounded-2xl bg-[#ebebeb] md:bg-[#47B105]">
            ...
            <Link href="/swap">
                <button className=" flex flex-row gap-[10px] p-[12px] px-8 sm:px-5 md:px-4  rounded-2xl bg-[#ebebeb] md:bg-[#AC1717]">
                <Image  src="/carretDown.svg"  alt='pay'  width={24}  height={24} />
