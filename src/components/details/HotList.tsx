...
const HotList = () => {
    const hotlists = [
        { imgURL: "/Trump.png", name: "dev.fun annt", author: "devann", id: 1 },
        { imgURL: "/Trump.png", name: "dev.fun annt", author: "devann", id: 2 },
        { imgURL: "/Trump.png", name: "dev.fun annt", author: "devann", id: 3 },
        { imgURL: "/Trump.png", name: "dev.fun annt", author: "devann", id: 4 },
    ]
    return (
        <div className="flex flex-col gap-[6px]">
            ...
            {hotlists.slice(0, 3).map((item) => {
                return (
                        ...
                        <div key={item.id} className="p-[12px] gap-[10px] rounded-[18px] bg-[#ebebeb] flex flex-row justify-between">
