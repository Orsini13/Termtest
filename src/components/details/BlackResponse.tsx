...
const BlackResponse = () => {
  return (
      <div className="flex flex-row w-[364px] h-[32px] justify-between p-[10px] rounded-br-[12px] rounded-bl-[12px] bg-black">
          <div className="flex flex-row gap-[4px] w-[86px] h-[12px]">
