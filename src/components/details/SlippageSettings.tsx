...
const SlippageSettings = () => {
  return (
      <div className="hidden p-[18px] bg-[#ebebeb] md:flex md:flex-col  rounded-[12px] md:justify-between">
          <div className="flex flex-col gap-[12px]">
              <h1 className={`${geologica.className}font-normal text-[16px] leading-[16px] lg:leading-[1] tracking-[0%] `}>Sell  (take profit)</h1>
